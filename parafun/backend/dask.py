...
try:
    ...
    raise ImportError("Dask dependencies missing. Use `pip install 'parafun[dask]'` to install Dask dependencies.")
...
from parafun.profiler.functions import profile, timed_function
